...
public class admitPateint extends JFrame implements ActionListener , WindowListener ,MouseListener,FocusListener,KeyListener
{
    JPanel p;
        JOptionPane msg;
        JLabel lreg,lnew,lname,lrm,ldr,ldis,ldtadm,ldtdis,ladd,lcont,lgrd,limg;
        JLabel chkreg,chkname,chkrm,chkdr,chkdis,chkdtadm,chkdtdis,chkadd,chkcont,chkgrd;
    ...
    admitPateint()
    {
        ...
        p=new JPanel();
      //  limg=new JLabel(new ImageIcon("/Users/kuldipsingh/Desktop/prj2019/nurse.jpg"));
      limg=new JLabel();  
      lreg=new JLabel("Registration No.");
        lnew=new JLabel("Discharge Form");
        ...
        chkdtdis=new JLabel(); chkadd=new JLabel(); chkcont=new JLabel(); chkgrd=new JLabel();
        ...
        lnew.setBounds(1000,50,250,30);    lnew.setFont(new java.awt.Font("Futura",1,23));         lnew.setForeground( new Color(255,255,0));
        ...
        chkdr.setVisible(true);
        chkdis.setVisible(true);
        chkdtadm.setVisible(true);
        chkdtdis.setVisible(true);
        chkadd.setVisible(true);
        chkcont.setVisible(true);
        chkgrd.setVisible(true);
        lreg.setVisible(true);
        lnew.setVisible(true);
        lname.setVisible(true);
        lrm.setVisible(true);
        ldr.setVisible(true);
        ldis.setVisible(true);
        ldtadm.setVisible(true);
        ldtdis.setVisible(true);
        ladd.setVisible(true);
        lcont.setVisible(true);
        lgrd.setVisible(true);
        tfreg.setVisible(true);
        tfname.setVisible(true);
        tfrmno.setVisible(true);
        tfdr.setVisible(true);
        tfdis.setVisible(true);
        tfdtadm.setVisible(true);
        tfdtdis.setVisible(true);
        tfcont.setVisible(true);
        submit.setVisible(true);
        cancel.setVisible(true);
        taadd.setVisible(true);
        tagrd.setVisible(true);
        msg.setVisible(true);    
        ...
        try
        {
            ...
            PreparedStatement ps;
                ...
                ps.setString(7,tfdtdis.getText());
                 ps.setString(8,taadd.getText());
                  ps.setString(9,tfcont.getText());
                   ps.setString(10,tagrd.getText());
    ...
    public void focusLost(FocusEvent e) 
    {
     Object o=e.getSource();
                     ...
                     if(o==tfdtdis)
                     { if(tfdtdis.getText().length()==0)
                         {
                             chkdtdis.setText("!Enter discharged date");
                            // tfdtdis.requestFocus();
                         }
                         else
                             chkdtdis.setText("");
                     }
